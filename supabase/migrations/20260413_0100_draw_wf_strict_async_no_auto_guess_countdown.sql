-- Draw WF: disable server guess countdown until actual participation; no auto-timeout while idle
-- This ensures a round can wait indefinitely (room expiry policy still applies).
...
begin
  ...
  -- No guess_deadline-based auto-resolution in strict async mode.
