-- Most Likely validation hardening:
-- - build validators from current lobby players (not stale order list)
-- - if validators end up empty, resolve immediately (no stuck group phase)
