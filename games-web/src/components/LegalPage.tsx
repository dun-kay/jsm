      ...
      <section className="screen screen-basic">
        ...
        {isTerms ? (
          <div className="runtime-flow legal-copy">
            ...
            <p><b>Paid access:</b> $1 USD unlocks unlimited sessions for 4 hours on that browser type/device only. $9.99 USD unlocks unlimited sessions for 30 days on that browser type/device only.</p>
          ...
          <div className="runtime-flow legal-copy">
            ...
            <p><b>Unlimited access:</b> $1 USD unlocks unlimited sessions for 4 hours on that browser type/device. $9.99 USD unlocks unlimited sessions for 30 days on that browser type/device. Refreshing the page or closing the tab and coming back to the same browser type is possible (provided your access time has not lapsed); unless you purchase in private mode, clear cookies/local storage, or change your browser type. </p>
            <p><b>Disclaimer:</b> Paid access and free sessions are tied to this browser type/device via local storage and cookies. If you clear cookies/local storage, use private mode, or switch browser types/devices, access may be lost. By continuing or purchasing, you accept this setup and understand this is not grounds for a refund. Issues, contact support.</p>
